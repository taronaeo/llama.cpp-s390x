...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_SAMPLERS;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"-s", "--seed"}, "SEED",
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_TEMP;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--top-k"}, "N",
        ...
        [](common_params & params, int value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_TOP_K;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--top-p"}, "N",
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_TOP_P;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--min-p"}, "N",
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_MIN_P;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--top-nsigma"}, "N",
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_XTC_PROBABILITY;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--xtc-threshold"}, "N",
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_XTC_THRESHOLD;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--typical"}, "N",
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, int value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_PENALTY_LAST_N;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--repeat-penalty"}, "N",
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_PENALTY_REPEAT;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--presence-penalty"}, "N",
    ...
    add_opt(common_arg(
        ...
        [](common_params & params, int value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_MIROSTAT;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--mirostat-lr"}, "N",
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_MIROSTAT_ETA;
        }
    ).set_sparam());
    add_opt(common_arg(
        {"--mirostat-ent"}, "N",
        ...
        [](common_params & params, const std::string & value) {
            ...
            params.sampling.sampling_config |= common_params_sampling_config::COMMON_PARAMS_SAMPLING_CONFIG_MIROSTAT_TAU;
        }
    ).set_sparam());
    add_opt(common_arg(
